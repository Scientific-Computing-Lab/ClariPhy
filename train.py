...
def main():
    ...
    while current_iter <= total_iters:
        ...
        while train_data is not None:
            ...
            preds = model.optimize_parameters(current_iter)
            ...
            if opt.get('val') is not None and (current_iter %
                ...
                #######
                import pdb; pdb.set_trace()
                lq_val = val_loader['lq']
                gt_val = val_loader['gt']
                # model.feed_data()
                my_loss = model.val_loss({'lq': lq_val, 'gt':gt_val})
                print(f'val_loss {my_loss}')
                tb_logger.add_scalar(f'val_loss', my_loss, current_iter)
