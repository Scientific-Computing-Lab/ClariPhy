...
parser.add_argument('--model_name', default='motion_deblurring')
...
def get_weights_and_parameters(task, parameters, model_name='motion_deblurring'):
    if task == 'Motion_Deblurring':
        weights = os.path.join('Motion_Deblurring', 'pretrained_models', f'{model_name}.pth')
...
weights, parameters = get_weights_and_parameters(task, parameters, model_name)
